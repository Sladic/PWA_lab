...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container">
        ...
        <section class="row">
            ...
            <?php
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='šah' LIMIT 3";
                $result = mysqli_query($dbc, $query);
                $i = 0;
                while($row = mysqli_fetch_array($result)) {
                    echo '<div class="card w-25 mx-2">';
        ...
        <section class="row">
            <div class="card-group">
            <?php
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='astrologija' LIMIT 3";
                $result = mysqli_query($dbc, $query);
                $i = 0;
                while($row = mysqli_fetch_array($result)) {
                    echo '<div class="card w-25 mx-2">';
